 ...
 */
?>
<?php if ($variables['result']['type'] == 'Post') : ?>
<div class="node node-teaser node-type-post">
  <div class="node-inner">
    ...
    <h2 class="title"><a href="<?php print $url; ?>"><?php print $title; ?></a></h2>
      <div class="submitted">by <strong><?php print $contributor; ?></strong></div>
  </div>
</div>
<?php elseif ($variables['result']['type'] == 'Theme Week Page') : ?>
  <div class="<?php print $type; ?> node-teaser">
    <div class="node-inner">
      <h2 class="title"><a href="<?php print $url; ?>"><?php print $title; ?></a></h2>
